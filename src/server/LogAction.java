...
public class LogAction {
    ...
    private static final String USER_LOG_FILE = "resources/inventories/user_log.txt";
    private static final String CUSTOMER_LOG_FILE = "resources/inventories/customer_log.txt";
